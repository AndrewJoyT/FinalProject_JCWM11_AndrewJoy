                ...
                <div style={{ margin: '0 0 90px 0' }}>
                    <Navbar color="dark" dark expand="md" fixed="top" className="shadow">
                        <NavbarBrand href="/" style={{ fontSize: "16px" }}>
                            <h2 className='cobacoba' style={{ lineHeight: '40px' }}>WELCOME, {this.props.username}</h2>
                        </NavbarBrand>
                        <NavbarToggler onClick={this.toggle} />
                        <Collapse isOpen={this.state.isOpen} navbar>
                    ...
                    <div style={{ height: '40px', marginRight: '-15px', marginLeft: '-15px', marginTop: '60px', backgroundColor: 'black', fontSize: '16px', lineHeight: '2em' }} className="text-center fixed-top font-weight-normal">
                        <div style={{ marginTop: '3px' }}>
                            <span><a className='headerkedua' href="/productsgridview" style={{ marginRight: '40px' , color:'white' }}><i className="fa fa-th"></i>  PRODUCT &nbsp;</a></span>
                            <span><a className='headerkedua' href="/cart" style={{ marginRight: '40px' , color:'white' }}><i className="fa fa-shopping-cart"></i>  CART &nbsp;</a></span>
                            <span><a className='headerkedua' href="/wishlist" style={{ marginRight: '40px' , color:'white' }}><i className="fa fa-heart"></i> WISHLIST &nbsp;</a></span>
                            <span><a className='headerkedua' href="/history" style={{ marginRight: '0px' , color:'white' }}><i className="fa fa-history"></i>  HISTORY&nbsp;</a></span>
                            <span><a className='headerkedua' href="/confirmorder" style={{ marginLeft: '40px', color:'white' }}><i className="fa fa-check" ></i>  CONFIRM PAYMENT &nbsp;</a></span>
                        </div>
                    </div>
                </div>
            )
