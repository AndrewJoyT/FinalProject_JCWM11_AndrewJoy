    ...
    render() {
      ...
      if(this.props.username === "") {
        ...
        if(this.props.loading) {
            ...
            load = <center><Button color="red" size="lg" block style={{ fontSize: "14px" }} 
              onClick={this.onBtnSubmit}><b>Sign in</b></Button></center>;
        }

        return (
          <div style={{height: "700px"}}>
          <div className="full-width-div card bg-white col-12" style={{paddingBottom: '305px', marginTop: '-10px'}}>
              <br/><br/>
